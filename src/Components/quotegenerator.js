...
{
    const quotes=['practice makes man perfect','Even miracles take a little time.','every apple a daya keeps the docter Away','slow and steady wins the race','drop and drop makes an ocean','quote 1','quote 2','quote 3','quote 4','quote 5']
